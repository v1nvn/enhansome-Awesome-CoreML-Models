...
* **Inception v3** - Detects the dominant objects present in an image. [Download](https://github.com/yulingtianxia/Core-ML-Sample/blob/master/CoreMLSample/Inceptionv3.mlmodel) ⭐ 222 | 🐛 1 | 🌐 Swift | 📅 2017-08-09 | [Demo](https://github.com/yulingtianxia/Core-ML-Sample/) ⭐ 222 | 🐛 1 | 🌐 Swift | 📅 2017-08-09 | [Reference](https://arxiv.org/abs/1512.00567)
